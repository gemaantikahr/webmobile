			...
			<div class="col-xl-3 col-sm-6 mb-3">
				<div class="card text-white bg-primary o-hidden h-60">
					<div class="card-body">
						...
						<div class="mr-12">
							<?php foreach ($banyaksaldo as $data): ?>
							Jumlah Saldo Rp. <?php echo $data->jumlah_saldo?>
							<?php endforeach;?>
						</div>
					</div>
			...
			<!-- <div class="col-xl-3 col-sm-6 mb-3">
				<div class="card text-white bg-info o-hidden h-60">
					<div class="card-body">
						...
						<div class="mr-12">
							<a class="text-white" href="<?php echo site_url('admin/sekolah/')?>">
				...
				<div class="card text-white bg-warning o-hidden h-100">
					<div class="card-body">
						...
						<div class="mr-12">
							...
							Banyak Pelanggan <php echo $data->banyak_pelanggan?>
							<php endforeach;?>
						</div>
					</div>
