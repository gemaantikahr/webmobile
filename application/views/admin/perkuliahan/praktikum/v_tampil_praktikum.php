	...
	<div id="wrapper">
		...
		<div id="content-wrapper">
							...
							<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<?php echo $data->nama_praktikum?>
										</td>
                                        <td>
                                            <?php echo $data->nama_asisten?>
                                        </td>
										<td>
                                             <?php echo $data->hari?>
										</td>
										...
										<td width="250">
											<a href="<?php echo site_url('admin/perkuliahan/praktikum/edit_praktikum/'.$data->id_praktikum) ?>"
											 class="btn btn-small text-primary"><i class="fas fa-edit"></i></a>
											<a data-toggle="modal" data-target="#ModalHapus<?php echo $data->id_praktikum?>"
		    ...
		    <?php foreach ($praktikum as $data):?>
				<div class="modal fade" id="ModalHapus<?php echo $data->id_praktikum;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
									<div class="form-group">
										...
										<strong><label for="inputUserName" class="col-sm-12 control-label"> <?php echo $data->nama_praktikum?></label></strong>
										<div class="col-sm-7">
										<input type="hidden" name="xid" value="<?php echo $data->id_praktikum;?>">
										</div>
									</div>
							</div>
